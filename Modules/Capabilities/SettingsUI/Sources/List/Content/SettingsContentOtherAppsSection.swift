...
struct SettingsContentOtherAppsSection: View {
    var body: some View {
        Section(header: SettingsSectionHeader(SettingsUIStrings.SettingsContentOtherAppsSection.header)) {
            OtherAppButton(
                name: "Barc",
                subtitle: "Save and store loyalty cards",
                id: "6642707689",
                asset: SettingsUIAsset.barc
            )
            OtherAppButton(
                name: "Kineo",
            ...
            OtherAppButton(
                ...
                id: "1510076117",
                asset: SettingsUIAsset.debigulator
            )
        }
    }
}
